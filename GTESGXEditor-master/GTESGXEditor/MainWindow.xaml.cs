    ...
    public partial class MainWindow : Window
    {
        ...
        private void RefreshSGXDEntries(bool fromListChange = false, bool skipEstimate = false)
        {
            ...
            if (lstEsgx != null)
            {
                ...
                lblCurrentVag.Content = "File to use: " + selectedSgxd.audioStreamName;
                if (selectedSgxd.audioStreamName == null)
                    lblCurrentVag.Content = "File to use: Default";
        ...
        {
            DialogResult result = System.Windows.Forms.MessageBox.Show("Are you sure you want to initialize it?", "", MessageBoxButtons.YesNo, MessageBoxIcon.None, MessageBoxDefaultButton.Button2);
